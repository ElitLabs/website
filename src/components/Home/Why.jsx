...
function Card({ title, text, icon }) {
	return (
		<div className="flex h-auto flex-col items-center rounded-2xl border-t-4 border-brand bg-neutral-50 p-2 pb-10 drop-shadow-[3px_2px_10px_rgba(232,46,81,0.15)] 2xl:pb-8 4xl:pb-12">
