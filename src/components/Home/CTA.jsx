	...
	return (
		<section className="mx-auto flex flex-row items-center gap-x-10 py-[2.5vh] md:grid lg:grid-cols-[55%,45%] lg:pt-24 xl:gap-x-4 xl:pb-[1vh] xl:pt-[5vh]">
			<span className="flex flex-col gap-y-2">
				<span className="pb-2 text-[3.35rem] font-bold leading-[4.5rem] 3xl:text-[3.75rem] text-center lg:text-left">
				...
				<span className="pb-3 text-2xl font-semibold text-neutral-500 dark:text-neutral-300 xl:pb-4 3xl:pb-5 text-center lg:text-left">
				...
				<button
					...
					className="mx-auto w-[75%] rounded-xl bg-gradient-to-r from-violet-500 via-blue-500 to-violet-500 bg-500% p-4 text-3xl font-semibold self-center lg:self-start text-neutral-50 transition duration-500 ease-in-out hover:scale-105 hover:animate-gradient sm:mx-0 lg:w-[55%] 3xl:w-[35%]">
					Join Now!
				</button>
			</span>
			<Image
