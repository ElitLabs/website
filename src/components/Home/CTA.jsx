	...
	return (
		<section className="mx-auto flex max-w-[80%] flex-row items-center gap-x-10 py-[2.5vh] lg:grid lg:grid-cols-[60%,40%] lg:pt-24 xl:gap-x-16 xl:pb-[1vh] xl:pt-[5vh]">
			<span className="flex flex-col 2xl:max-w-[80%]">
				<span className="pb-2 text-[3.35rem] font-bold leading-[4.5rem] 3xl:text-[3.75rem]">
				...
				<span className="pb-3 text-xl font-semibold text-neutral-500 dark:text-neutral-300 xl:pb-4 3xl:pb-5">
				...
				<button
					...
					className="mx-auto w-[75%] rounded-xl bg-gradient-to-r from-violet-500 via-blue-500 to-violet-500 bg-500% p-4 text-3xl font-semibold text-neutral-50 transition duration-500 ease-in-out hover:scale-105 hover:animate-gradient sm:mx-0 lg:w-[55%] 3xl:w-[35%]">
					Join Now!
				</button>
			</span>
			<Image
