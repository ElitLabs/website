...
export default function About() {
	return (
		<div className="mx-auto flex w-full flex-col items-center justify-center py-10 lg:max-w-[70%]">
			<div className="flex flex-col items-center justify-center gap-y-[10vh] pt-4 lg:pt-[2.5vh] 3xl:pt-[12.5vh]">
				<header className="flex w-full max-w-[90%] lg:max-w-[70%] flex-col items-center justify-center">
					<h1 className="text-gradient animate-sgradient bg-gradient-to-l from-pink-600 via-purple-600 to-pink-600 bg-500% text-center font-mono text-[3rem] lg:text-[3.125rem] font-black uppercase tracking-wide dark:from-pink-500 dark:via-purple-500 dark:to-pink-500">
						Our Mission
					</h1>
					<h2 className="text-center text-3xl lg:text-[3.25rem] 3xl:text-[3.45rem] font-semibold leading-[3rem]">
						We aim to help aspiring developers from all backgrounds learn to
						code
					</h2>
				</header>
				<div className="max-w-[90%] lg:max-w-[65%]">
					<h1 className="text-center font-mono text-[2.825rem] font-black uppercase tracking-wide">
						Our Story
					</h1>
					<p className="text-center text-2xl 3xl:text-3xl font-medium">
