...
export default function Contact() {
	return (
		<div className="flex h-full w-full flex-col items-center justify-center pb-10 pt-10 lg:pt-[5vh] 3xl:pt-[25vh]">
			...
			<div className="flex max-w-[90%] grid-cols-2 3xl:grid-cols-3 flex-col gap-x-16 gap-y-10 lg:grid lg:max-w-[75%] ">
				<div className="grid grid-cols-1 justify-between gap-y-4 rounded-md border-1 border-neutral-950 bg-gradient-to-bl from-neutral-100 to-neutral-50 p-6 dark:border-neutral-600 dark:from-neutral-900 dark:to-neutral-950">
				...
				<div className="grid grid-cols-1 justify-between gap-y-4 rounded-md border-1 border-neutral-950 bg-gradient-to-b from-neutral-100 to-neutral-50 p-6 dark:border-neutral-600 dark:from-neutral-900 dark:to-neutral-950">
					<h1 className="text-center text-3xl font-semibold">
				...
				<div className="lg:col-span-2 3xl:col-span-1 w-full lg:w-[50%] 3xl:w-full mx-auto flex flex-col justify-between gap-y-4 rounded-md border-1 border-neutral-950 bg-gradient-to-br from-neutral-100 to-neutral-50 p-6 dark:dark:border-neutral-600 dark:from-neutral-900 dark:to-neutral-950">
					<h1 className="text-center text-3xl font-semibold">
						Join our community!
					</h1>
					<div className="mx-auto w-min gap-x-4 font-mono text-xl">
